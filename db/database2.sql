...
insert into Organization(organization_name, phone, email, id_location, Organization_type) 
    value ("ProNoa S.R.L.", "0388 427-0598", "pronoa@gmail.com", 6, "Sociedad de responsabilidad limitada");


insert into Organization(organization_name, phone, email, id_location, Organization_type) 
    value ("Eco Norte Reciclaje", "0388 15-462-2161", "info@econortereciclado.com.ar", 1, "Sociedad de responsabilidad limitada");


insert into Container(id_container, longitude, latitude, id_location, id_container_type, organization_name) 
    value (null, "-24.186265872215632", "-65.29993714871891", 1, 1, "ProNoa S.R.L.");

insert into Container(id_container, longitude, latitude, id_location, id_container_type, organization_name) 
    value (null, "-24.184266891394362", "-65.3138125596427", 1, 1, "ProNoa S.R.L.");

insert into Container(id_container, longitude, latitude, id_location, id_container_type, organization_name) 
    value (null, "-24.191218420633565", "-65.29398601458216", 1, 2, "ProNoa S.R.L.");

insert into Container(id_container, longitude, latitude, id_location, id_container_type, organization_name) 
    value (null, "-24.197691881172982", "-65.29108968307749", 1, 1, "Eco Norte Reciclaje");

insert into Container(id_container, longitude, latitude, id_location, id_container_type, organization_name) 
    value (null, "-24.253474880351217", "-65.2155544764568 ", 6, 1, "ProNoa S.R.L.");
